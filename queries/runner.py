...
BLOCKS = [
    ...
    },
    {
        ...
        "description": "Vault withdrawal flows during stress period",
        "outputs": ["block7_vault_withdrawals.csv"],
        "inputs": ["block1_vaults_graphql.csv"],
    },
    {
        "name": "block8_plume",
        "module": "block8_query_plume_deep_dive",
        "description": "Full market deep dive: all affected markets (Plume, Ethereum, Arbitrum)",
        "outputs": [
            "block8_plume_transactions.csv",
            "block8_plume_market_history.csv",
            "block8_plume_borrower_positions.csv",
            "block8_elixir_stream_transactions.csv",
            "block8_elixir_stream_market_history.csv",
            "block8_elixir_stream_positions.csv",
            "block8_eth_transactions.csv",
            "block8_eth_market_history.csv",
            "block8_arb_transactions.csv",
            "block8_arb_market_history.csv",
            "block8_arb_positions.csv",
            "block8_eth_deusd_transactions.csv",
            "block8_eth_deusd_market_history.csv",
...
def patch_and_run(block: dict):
    ...
    # Patch DATA_DIR for scripts that use it directly (e.g. block8)
