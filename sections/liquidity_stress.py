...
from utils.charts import fmt_usd_cols,  apply_layout, depeg_vline, RED, BLUE, ORANGE, GREEN, format_usd
...
def render():
    ...
    if not net_flows.empty:
        ...
        # Pre-format percentage as string for clean export
        stress["net_change_pct"] = stress["net_change_pct"].apply(lambda x: f"{x:.1f}")
