...
def render():
    ...
    with col2:
        with st.container(border=True):
            ...
            st.markdown(
                "Synthetic dollar protocol whose backing was deeply intertwined "
                "with Stream Finance. Elixir lent **\\$68M USDC** to Stream "
    ...
    with col1:
        with st.container(border=True):
            ...
            st.markdown(
                ...
                "— to Stream through **private, non-whitelisted Morpho markets** where Stream was "
    ...
    st.markdown(
        ...
        "Protocol assets to cover these losses — the beginning of an alleged "
    ...
    st.markdown(
        ...
        "(\\$100–128M across 6+ chains) created broader DeFi market stress — but this was "
        "**concurrent, not causal**. The lawsuit timeline confirms the fund losses occurred "
        "on November 2, the day prior. Multiple analysts noted the Balancer event may have "
        "masked the Stream-specific situation initially."
    )
